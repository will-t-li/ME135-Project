...
int main(void)
{
	uint32_t timer_frequency = 10000;
    cy_rslt_t result;
        			...
        			if (led_blink_active_flag)
        			                {
        			                    ...
        			                    printf("TLED blinking paused \r\n");
        			                }
        			                else /* Resume LED blinking by starting the timer */
        			                {
        			                    cyhal_timer_start(&led_blink_timer);

        			                    printf("TLED blinking resumed\r\n");
        			                }
        			led_blink_active_flag ^= 1;
        			break;
        		case 'A':
        			printf("AReceived the A Command\r\n");
        			cyhal_timer_set_frequency(&led_blink_timer, LED_BLINK_TIMER_CLOCK_HZ);
        			timer_frequency = LED_BLINK_TIMER_CLOCK_HZ;
        			break;
        		case 'B':
        			printf("BReceived the B Command\r\n");
        			timer_frequency = timer_frequency+10000;
        			cyhal_timer_set_frequency(&led_blink_timer, timer_frequency);
        			break;
        		case 'I':
        		    printf("IPSOC\r\n");
        		  	break;
